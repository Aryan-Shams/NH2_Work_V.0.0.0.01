      ...
      <aside id="left-sidebar-nav">
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
                  ...
                  <div class="row">
                      ...
                      <div class="col col s8 m8 l8">
                          <ul id="profile-dropdown" class="dropdown-content">
                                <!--
                              <li><a href="userprofile.php"><i class="mdi-action-face-unlock"></i> Profile</a>
                              </li>
           ...
           <li class="bold"><a href="change_userpass.php" class="waves-effect waves-cyan">            <i class="mdi-action-lock-outline prefix"></i>
 Change Password</a>
              </li>
